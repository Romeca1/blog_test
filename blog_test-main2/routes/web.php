...
Route::get('/homePage/create',[PageController::class,"GetCreatePostPage"]);
Route::get('/homePage/myPosts',[PageController::class,"GetMyPostPage"]);
Route::get('/homePage/profile',[PageController::class,"GetProfilePage"]);
Route::get('/homePage/myPosts/upDate',[PageController::class,"GetUpDatePage"]);
